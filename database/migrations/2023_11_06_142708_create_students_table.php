...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('students', function (Blueprint $table) {
            ...
            $table->string('orphelin', 255)->nullable();
            $table->string('orph', 255)->nullable();
            ...
            $table->string('activity_group', 255)->nullable();
            $table->string('phone', 255)->nullable();
            $table->string('address', 255)->nullable();
            $table->string('habita', 255)->nullable();
            $table->timestamp('date_enter')->nullable();

            $table->string('job_parent', 255)->nullable();
            $table->string('type_parent')->nullable();
            $table->foreignId('parent_id')->nullable()->constrained('students')->onDelete('set null')->cascadeOnUpdate();
